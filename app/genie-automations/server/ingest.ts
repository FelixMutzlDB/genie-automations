...
export function validImageBytes(raw: Buffer, extension: IngestExtension): boolean {
  if (extension === 'png')
    return raw.length >= 8 && raw.subarray(0, 8).equals(Buffer.from('89504e470d0a1a0a', 'hex'));
